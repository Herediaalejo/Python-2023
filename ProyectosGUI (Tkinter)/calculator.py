...
buttonAC.grid(row=1,column=0, pady=5)
buttonPar1.grid(row=1,column=1, pady=5)
buttonPar2.grid(row=1,column=2, pady=5)
buttonDiv.grid(row=1,column=3, pady=5)
button7.grid(row=2,column=0, pady=5)
button8.grid(row=2,column=1, pady=5)
button9.grid(row=2,column=2, pady=5)
buttonMult.grid(row=2,column=3, pady=5)
button4.grid(row=3,column=0, pady=5)
button5.grid(row=3,column=1, pady=5)
button6.grid(row=3,column=2, pady=5)
buttonRest.grid(row=3,column=3, pady=5)
button1.grid(row=4,column=0, pady=5)
button2.grid(row=4,column=1, pady=5)
button3.grid(row=4,column=2, pady=5)
buttonSum.grid(row=4,column=3, pady=5)
button0.grid(row=5,column=0, pady=5)
buttonDec.grid(row=5,column=1, pady=5)
buttonDel.grid(row=5,column=2, pady=5)
buttonEq.grid(row=5,column=3, pady=5)
