...
def nueva_pregunta():
    ...
    if pregunta_seleccionada:
        ...
        opcion1.config(text=respuestaCor)
        opcion2.config(text=respuestaInc1)
        opcion3.config(text=respuestaInc2)
        opcion4.config(text=respuestaInc3)
    else:
        fin_juego()
...
def fin_juego():
    ...
    fin_label = tk.Label(window, text="Felicidades! Finalizaste el juego.", font=(font,60))
    ...
    regresar_button.grid(row=10,column=0,columnspan=4)


def create_window():
    global font, time_label, preguntaLabel, opcion1, opcion2, opcion3, opcion4

    bgcolor = "#4a4949"

    eliminar_widgets(window)
    
    bg_colors = ["purple", "red", "blue", "yellow"]
    bgcolor_pregunta = random.choice(bg_colors)
    rojo = "#f54254"
    azul = "#4287f5"
    verde = "#42f57b"
    amarillo = "#f5e342"
    ...
    opcion1 = tk.Button(window, width=20, bg="lightgray", cursor="hand2", relief="flat", font=(font, 20), background=button_color[0], command=lambda:[sumar_puntos(), nueva_pregunta()])
    opcion1.grid(row=button_grid[0][0], column=button_grid[0][1], sticky="nsew", padx=(button_grid[0][2],button_grid[0][3]))
    opcion2 = tk.Button(window, width=20, bg="lightgray", cursor="hand2", relief="flat", font=(font, 20), background=button_color[1], command=lambda:[nueva_pregunta()])
    opcion2.grid(row=button_grid[1][0], column=button_grid[1][1], sticky="nsew", padx=(button_grid[1][2],button_grid[1][3]))
    opcion3 = tk.Button(window, width=20, bg="lightgray", cursor="hand2", relief="flat", font=(font, 20), background=button_color[2], command=lambda:[nueva_pregunta()])
    opcion3.grid(row=button_grid[2][0], column=button_grid[2][1], sticky="nsew", padx=(button_grid[2][2],button_grid[2][3]))
    opcion4= tk.Button(window, width=20, bg="lightgray", cursor="hand2", relief="flat", font=(font, 20), background=button_color[3], command=lambda:[nueva_pregunta()])
...
def main():
    global font, listaPreguntas, window, screen_width
    ...
    title.grid(row=0,column=0, columnspan=2, rowspan=2, padx=(100,0))
    ...
    form.grid(row=3,column=0,columnspan=2, rowspan=12, sticky="ns", padx=(100,0))
    ...
    newGame_button = tk.Button(window, width=20, text="NUEVO JUEGO", bg="#5bd0f0",cursor="hand2",font=(font, 16), relief="flat", command=lambda:[create_window()])
    ...
    exit_button.grid(row=13,column=0, columnspan=2, rowspan=2, padx=(100,0))
